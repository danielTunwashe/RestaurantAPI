...
namespace Restaurants.Application.Dishes.Commands.CreateDish
{
    public class CreateDishCommandHandler : IRequestHandler<CreateDishCommand, int>
    {
        ...
        public CreateDishCommandHandler(IRestauantsRepository restaurantRepository, IMapper mapper, ILogger<CreateDishCommandHandler> logger, IDishesRepository dishesRepository, IRestaurantAuthorizationService restaurantAuthorizationService)
        {
