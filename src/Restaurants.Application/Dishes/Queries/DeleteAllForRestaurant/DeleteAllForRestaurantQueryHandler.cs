...
namespace Restaurants.Application.Dishes.Queries.DeleteAllForRestaurant
{
    public class DeleteAllForRestaurantQueryHandler : IRequestHandler<DeleteAllForRestaurantQuery>
    {
        ...
        public DeleteAllForRestaurantQueryHandler(ILogger<DeleteAllForRestaurantQueryHandler> logger, IRestauantsRepository restauantsRepository, IDishesRepository dishesRepository, IRestaurantAuthorizationService restaurantAuthorizationService)
        {
            _logger = logger;
