...
{
    public class UpdateRestaurantCommandHandler(IRestauantsRepository repository, ILogger<UpdateRestaurantCommandHandler> logger, IMapper mapper, IRestaurantAuthorizationService restaurantAuthorizationService) : IRequestHandler<UpdateRestaurantCommand>
    {
        ...
        public async Task Handle(UpdateRestaurantCommand request, CancellationToken cancellationToken)
        {
            ...
            //For update purposes, maps the request into an existing restaurant
